...
import pandas as pd
import os
leison_bad_names=os.listdir(r'D:\BaiduNetdiskDownload\BrainData\bad_copy')
leison_medium_names=os.listdir(r'D:\BaiduNetdiskDownload\BrainData\medium_copy')
leison_slight_names=os.listdir(r'D:\BaiduNetdiskDownload\BrainData\slight')
lesion_none_names=os.listdir(r'D:\BaiduNetdiskDownload\BrainData\none')

label_output_path=r'D:\BaiduNetdiskDownload\DongyingData\labeloutput'
...
sitk.WriteImage(final_image,'./output/bad_label_sum.nii')
