...
name_file=open(r'D:\pythonScripts\nonRigidRegistration\output\LesionAera_Lung.txt',\
    'r')
...
for train_index,test_index in skf.split(X,y):
    ...
    # fw_train=open('./logistic_cv_extrusion_1/train_'+str(count)+'.txt','a')
    # fw_test=open('./logistic_cv_extrusion_1/test_'+str(count)+'.txt','a')
    # count+=1
